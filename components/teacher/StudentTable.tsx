/**
 * Student Table Component for Teacher
 * Displays list of students in teacher's class with action buttons
 * Styled to match UserTable with vertical separators
 */
...
interface StudentTableProps {
    ...
    onGivePoints: (student: Profile) => void
    isLoading?: boolean
    itemsPerPage?: number
}
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr style={{ backgroundColor: headerBg }}>
                            ...
                            <th
                                className="px-4 py-3 text-center text-sm font-bold text-white w-24 border-r-2 border-white/30"
                            >
                                Poin
                            </th>
