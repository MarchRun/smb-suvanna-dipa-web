/**
 * Schedule Table Component for Teacher
 * Displays list of schedules/events with action buttons
 * Styled to match StudentTable with vertical separators
 */
                ...
                <table className="w-full border-collapse">
                    <thead>
                        <tr style={{ backgroundColor: headerBg }}>
                            ...
                            <th className="px-4 py-3 text-center text-sm font-bold text-white w-40">
                                Aksi
                            </th>
                        </tr>
                    </thead>
